...
<head>
    ...
    @if(isset($general_settings) && $general_settings->favicon)
        <link rel="icon" href="{{ $general_settings->favicon_url }}">
    @endif
</head>
<body>
    <div id="app">
            ...
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    @if(isset($general_settings) && $general_settings->logo)
                        <img src="{{ $general_settings->logo_url }}" alt="Logo" height="30" class="d-inline-block align-top me-2">
                    @endif
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        @auth
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('admissions.index') }}">{{ __('Students') }}</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('teacher-profiles.index') }}">{{ __('Teachers') }}</a>
                            </li>
                            <li class="nav-item">
